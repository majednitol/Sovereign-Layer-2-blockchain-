...
func TestPrimaryE2EScenario(t *testing.T) {
	...
	amount := sdk.NewCoins(sdk.NewCoin("usov", math.NewInt(5000000)))
	...
	newAmount := amount.AmountOf("usov")
	...
	s.BankKeeper.balances[receiver] = s.BankKeeper.balances[receiver].Add(sdk.NewCoin("usov", newAmount))
	...
	expectedPayout := sdk.NewCoins(sdk.NewCoin("usov", math.NewInt(10000000)))
	...
	payoutCoins := sdk.NewCoins(sdk.NewCoin("usov", math.NewInt(2500000)))
...
func TestNatsOutageChaos(t *testing.T) {
	...
	amount := sdk.NewCoins(sdk.NewCoin("usov", math.NewInt(1000000)))
